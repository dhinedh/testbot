...
async function sendInteractiveButtons(to, bodyText, buttonLabels) {
    ...
    const buttons = buttonLabels.map((label, index) => ({
        type: "reply",
        reply: { id: `btn_${index + 1}`, title: label.substring(0, 20) }
    }));
...
async function handleBotReply(phone, messageText, contact) {
    ...
    if (msg === "5" || msg === "btn_5" || msg.includes("human") || msg.includes("agent") || msg.includes("talk to someone")) {
    ...
    if (msg === "4" || msg.includes("contact") || msg.includes("location") || msg.includes("address")) {
        await sendMessage(phone, `📞 *Contact Deepika Builtech Engineering*\n\n*📱 Call or WhatsApp:*\n+91 96000 67611\n+91 98844 87938\n\n*📧 Email:*\ndbtechengg@gmail.com\n\n*🌐 Website:*\ndeepikabuiltech.com\n\n*📍 Our 3 Locations:*\n\n*Head Office — Chennai:*\nSIDCO Industrial Estate\nAmbattur, Chennai — 600098\n\n*Unit I — Kanchipuram:*\nRajakulam Road\nKanchipuram District — 631561\n\n*Unit II — Thiruvallur:*\nSIDCO Industrial Estate\nThirumullaivoyal — 600062\n\n*🕐 Working Hours:*\nMonday – Saturday: 9 AM – 6 PM`);
        await sendInteractiveButtons(phone, `What would you like to do?`, ["Get Free Quote 📋", "View Services 🔧", "Main Menu 🏠"]);
        return;
    }
